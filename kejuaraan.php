              <section id="toto" class="hero is-fullheight">
...
<?php 
 $ambil = mysqli_query($koneksi,"SELECT * FROM lomba WHERE kategori LIKE '1'");
                      ...
                      <div class="col-md-3">
                        <div>
                          <div class="padingkanankiri putih">
                            <a href="index.php?halaman=web" class="button is-danger fullwidth">Web Design</a>
                            ...
                            <a href="index.php?halaman=animasi" class="button fullwidth">Animasi</a>
